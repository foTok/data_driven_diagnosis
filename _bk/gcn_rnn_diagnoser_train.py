...
from ann_diagnoser.gcn_rnn_diagnoser import gcn_rnn_diagnoser
...
# settings
logfile = 'GCN_RNN_Training_' + time.asctime( time.localtime(time.time())).replace(" ", "_").replace(":", "-")+'.txt'
...
for t in range(times):
    ...
    for hidden_size in hidden_size_vec:
        ...
        diagnoser = gcn_rnn_diagnoser(graph, feature_maps, hidden_size, fc_number)
        print(diagnoser)
