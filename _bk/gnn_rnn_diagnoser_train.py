...
from ann_diagnoser.gnn_rnn_diagnoser import gnn_rnn_diagnoser
...
# settings
logfile = 'GNN_RNN_Training_' + time.asctime( time.localtime(time.time())).replace(" ", "_").replace(":", "-")+'.txt'
...
for t in range(times):
    ...
    for hidden_size in hidden_size_vec:
        ...
        diagnoser = gnn_rnn_diagnoser(graph, hidden_size, fc_number)
        print(diagnoser)
